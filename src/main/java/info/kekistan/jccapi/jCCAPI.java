...
public class jCCAPI {
    ...
    public String getFirmwareVersion() {
        String fw = getFirmwareInfo();
        return fw.substring(1, 2) + "." + fw.substring(3, 5);
    }

    public String getConsoleType() {
        String fw = getFirmwareInfo();
        int consoletype = Integer.parseInt(fw.substring(fw.length()-1));
        switch (consoletype) {
            case 0:
                return "UNK";
            case 1:
    ...
    private String getFirmwareInfo() {
        return handleRequest("getfirmwareinfo", false);
    }

    public void shutDown(int mode) {
        handleRequest("shutdown", false, "mode=" + Integer.toString(mode));
    }
